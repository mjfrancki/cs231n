...
class TwoLayerNet(object):
    ...
    def __init__(self, input_dim=3*32*32, hidden_dim=100, num_classes=10,
        ...
        ############################################################################
        self.params["W1"] = np.random.randn(input_dim, hidden_dim)*0.001
        self.params["W2"] = np.random.randn(hidden_dim,input_dim)*0.001
    ...
    def loss(self, X, y=None):
        ...
        #RelU = np.maximum(0, np.dot(X,  model.params['W1'] ) + self.params["b1"]  ) 
        
        #print( np.dot(RelU, self.params["W2"] ) )
        ...
        scores, cache = affine_forward( affine_relu_forward(X, self.params['W1'], self.params['b1'] )  , self.params['W2'], self.params['b2'] )
        '''
        #return scores
        ...
        dscores, dW2, db2 = affine_backward(dscores, cache_2)
        dscores, dW1, db1 = affine_relu_backward(dscores,cache_1)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for i in range(1, self.num_layers + 1):
            ...
            scores, cache = affine_forward(scores, self.params['W' + str(i)],  self.params['b' + str(i)])
            caches.append(cache)
            
            if i < self.num_layers :
                if self.use_batchnorm:
                    out, cache = affine_batchnorm_relu_forward( input_data, self.params[Wi], self.params[bi], self.params[yi], self.params[betai], self.bn_params[layer] )
